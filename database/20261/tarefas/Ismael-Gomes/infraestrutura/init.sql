...
insert into departamento (sigla, descricao, gerente) values
...
insert into funcionario (nome, sexo, dt_nasc, salario, supervisor, depto)
...
insert into projeto (nome, descricao, depto, responsavel, data_inicio, data_fim) values
